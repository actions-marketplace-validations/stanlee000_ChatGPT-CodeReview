...
4. Change to `Variables` tab, create a new variable `AZURE_OPENAI_API_KEY` with the value of your open api key (For Github Action integration, set it in secrets)
