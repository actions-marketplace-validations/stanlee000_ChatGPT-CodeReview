...
4. `Variables` 탭으로 변경합니다, `New repository variable` 버튼을 눌러서 새로운 `AZURE_OPENAI_API_KEY` 변수를 생성합니다. 변수의 값으로 당신의 open api key 를 입력합니다. (OpenAI 홈페이지에서 api 키를 받을 수 있습니다.)
...
1. `AZURE_OPENAI_API_KEY` 를 당신의 github actions secrets 에 추가합니다.
